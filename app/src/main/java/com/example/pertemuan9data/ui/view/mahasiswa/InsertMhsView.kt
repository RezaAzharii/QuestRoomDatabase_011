...
import com.example.pertemuan9data.ui.navigation.AlamatNavigasi
import com.example.pertemuan9data.ui.viewmodel.FormErrorState
import com.example.pertemuan9data.ui.viewmodel.MahasiswaEvent
import com.example.pertemuan9data.ui.viewmodel.MahasiswaViewModel
import com.example.pertemuan9data.ui.viewmodel.MhsUIState
    ...
    LaunchedEffect(uiState.snackBarMassage){
        uiState.snackBarMassage?.let { message ->
            coroutineScope.launch {
                ...
                viewModel.resetSanckBarMessage()
            }
        }
    }
    Scaffold (
